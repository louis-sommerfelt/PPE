...
public class CBDD {
    ...
    public int executerRequeteUpdate(String requete) {
        try {
            stmt = conn.createStatement();  // on créé un objet avant pour créer un statemnt
   ...
   public static boolean testerConnexion(String nomFichierProperties) {
    ...
    public static String pretraiterChaineSQL(String s)   // ça permet d'intégrer des appostrophes 
    {
